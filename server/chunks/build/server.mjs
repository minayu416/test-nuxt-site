...
const __nuxt_page_meta$2 = {
  layout: "testlayout"
  // 指定使用 layouts/defaultEPaper.vue 這個佈局
};
...
const _routes = [
  {
    ...
    component: () => import('./index-M83GX-Lv.mjs')
  },
  {
    name: "posts",
    path: "/posts",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-DaecD2_g.mjs')
  },
  {
    name: "posts-slug",
    path: "/posts/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-oM8wRVa7.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CJn5_Ltx.mjs').then((m) => m.default || m)),
  epaper: defineAsyncComponent(() => import('./epaper-DbhNNF_M.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DqQ4H-wS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C-xh3-tu.mjs'));
